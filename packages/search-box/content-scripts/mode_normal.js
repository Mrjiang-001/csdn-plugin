...
class NormalMode extends KeyHandlerMode {
  init (options) {
    ...
    chrome.storage.onChanged.addListener((changes, area) => {
      if (area === "local" && changes.normalModeKeyStateMapping && changes.normalModeKeyStateMapping.newValue) { this.setKeyMapping(changes.normalModeKeyStateMapping.newValue); }
    });
  }
